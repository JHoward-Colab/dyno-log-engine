...
// Workspace Rendering & Sync Logic
// =========================================================================
...
function setA8Status(sheet, statusMessage) {
  ...
  } else if (upper.includes("CONDITIONAL") || upper.includes("ATTENTION") || upper.includes("PENDING")) {
...
function manageOperatorStation(e) {
  ...
  tableRange.clearContent().setBackground("#FFFFFF").setFontColor("#000000").setFontWeight("normal");   
...
function renderOperatorTableWithFormatting(ss, sheet, searchBarcode, partNumber) {
  ...
  var rawC1 = getAbsPair(limitValues[0][0], limitValues[0][1]); 
  var rawR1 = getAbsPair(limitValues[0][2], limitValues[0][3]); 
  var rawC2 = getAbsPair(limitValues[1][0], limitValues[1][1]); 
  var rawR2 = getAbsPair(limitValues[1][2], limitValues[1][3]); 
